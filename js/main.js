...
initMap = () => {
  ...
  L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.jpg70?access_token={mapboxToken}', {
    mapboxToken: 'pk.eyJ1Ijoic3NhaCIsImEiOiJjam4zMDNta2gyYmlvM3FxdjdtbHM5eGw0In0.RdN7sSq7_6cp-pgqOY-Xfg',
    maxZoom: 18,
...
createRestaurantHTML = (restaurant) => {
  ...
  //Added role as button and aria-label
